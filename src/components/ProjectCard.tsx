...
export function ProjectCard({ name, description, tech, github, demo, icon: IconName, highlight }: ProjectCardProps) {
  ...
  return (
    <article className="group bg-white dark:bg-dark-900 rounded-2xl p-6 border border-gray-200 dark:border-dark-700 hover:border-primary-500/50 dark:hover:border-primary-500/50 transition-all duration-300 hover:shadow-xl">
